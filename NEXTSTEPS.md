...
# Next Steps for ndx-biosample Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-biosample directory.
...
`spec/ndx-biosample.namespace.yaml` and
`spec/ndx-biosample.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-biosample
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-biosample/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-biosample/0.1.0
...
`staged-extensions/ndx-biosample`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-biosample
    ```

13. Edit `staged-extensions/ndx-biosample/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-biosample
      version: 0.1.0
      src: https://github.com/bendichter/ndx-biosample
      pip: https://pypi.org/project/ndx-biosample/
      license: BSD-3
      maintainers: 
        - bendichter
      ```

14. Edit `staged-extensions/ndx-biosample/README.md`
to add information about your extension. You may copy it from
`ndx-biosample/README.md`.

  ```bash
  cp ndx-biosample/README.md staged-extensions/ndx-biosample/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-biosample
git commit -m "Add new catalog entry for ndx-biosample" .
git push
```
...
ndx-biosample-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-biosample GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-biosample-record repository on GitHub.
